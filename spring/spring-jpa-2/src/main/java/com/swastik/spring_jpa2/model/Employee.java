...
public class Employee {
    ...
    @JoinTable(name = "employee_techstack", joinColumns = @JoinColumn(name = "employee_emp_id"),
            inverseJoinColumns = @JoinColumn(name = "techstack_stack_id"), uniqueConstraints = @UniqueConstraint(columnNames = {"employee_emp_id", "techstack_stack_id"}))
