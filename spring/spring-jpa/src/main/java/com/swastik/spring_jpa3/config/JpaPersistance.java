package com.swastik.spring_jpa3.config;
...
@EnableJpaRepositories(basePackages = { "com.swastik.spring_jpa3.service" })
@ComponentScan(basePackages = { "com.swastik.spring_jpa3" })
...
public class JpaPersistance {
	...
	LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		entityManagerFactory.setPackagesToScan("com.swastik.spring_jpa3.model");
