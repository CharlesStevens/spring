package com.swastik.spring_jpa2.config;
...
@EnableJpaRepositories(basePackages = { "com.swastik.spring_jpa2.service" })
@ComponentScan(basePackages = { "com.swastik.spring_jpa2" })
...
public class JpaPersistance {
	...
	LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		entityManagerFactory.setPackagesToScan("com.swastik.spring_jpa2.model");
