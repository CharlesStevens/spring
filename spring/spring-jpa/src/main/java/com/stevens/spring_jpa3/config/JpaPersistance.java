package com.stevens.spring_jpa3.config;
...
@EnableJpaRepositories(basePackages = { "com.stevens.spring_jpa3.service" })
@ComponentScan(basePackages = { "com.stevens.spring_jpa3" })
...
public class JpaPersistance {
	...
	LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		entityManagerFactory.setPackagesToScan("com.stevens.spring_jpa3.model");
