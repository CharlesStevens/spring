...
@EnableJpaRepositories(basePackages =
    "com.stevens.spring_jpa_query.empRepo", entityManagerFactoryRef = "entityManagerFactory2",
...
public class JpaPersistance2 {
  ...
  LocalContainerEntityManagerFactoryBean entityManagerFactory2() {
    ...
    entityManagerFactory.setPackagesToScan("com.stevens.spring_jpa_query.empModel");
