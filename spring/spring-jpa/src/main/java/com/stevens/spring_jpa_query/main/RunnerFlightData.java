...
import com.stevens.spring_jpa_query.model.FlightData;
import com.stevens.spring_jpa_query.service.AddressService;
import com.stevens.spring_jpa_query.service.FlightDataService;
import com.stevens.spring_jpa_query.service.PersonService;
import java.io.File;
...
//    ctx.register(JpaPersistance.class, JpaPersistance2.class);
    ctx.scan("com.stevens.spring_jpa_query");
    ctx.refresh();
