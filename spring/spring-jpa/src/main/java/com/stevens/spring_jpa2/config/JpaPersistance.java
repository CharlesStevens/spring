package com.stevens.spring_jpa2.config;
...
@EnableJpaRepositories(basePackages = { "com.stevens.spring_jpa2.service" })
@ComponentScan(basePackages = { "com.stevens.spring_jpa2" })
...
public class JpaPersistance {
	...
	LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		entityManagerFactory.setPackagesToScan("com.stevens.spring_jpa2.model");
