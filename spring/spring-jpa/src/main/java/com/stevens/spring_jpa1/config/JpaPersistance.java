package com.stevens.spring_jpa1.config;
...
@EnableJpaRepositories(basePackages = { "com.stevens.spring_jpa1.service" })
@ComponentScan(basePackages = { "com.stevens.spring_jpa1" })
...
public class JpaPersistance {
	...
	LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		entityManagerFactory.setPackagesToScan("com.stevens.spring_jpa1.model");
